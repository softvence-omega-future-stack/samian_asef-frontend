  ...
  return (
    <div className="flex h-screen bg-[#F3F6F6] overflow-hidden">
      ...
      <div className="hidden lg:block lg:w-1/2 p-[10px] relative h-full">
        <img src={logiImg} alt="Signup" className="w-full h-full rounded-[16px] object-cover" />
        <div
          style={{
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 h-full">
        <div className="w-full max-w-md space-y-6">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full py-3 bg-primaryColor text-white rounded-[8px] font-medium hover:bg-teal-600 transition cursor-pointer"
            >
              Sign Up
            </button>
